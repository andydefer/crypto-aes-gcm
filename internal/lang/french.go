...
func (f FrenchBundle) GetMessage(key Key, args ...interface{}) string {
	...
	case CliErrorInvalidLanguage:
		format = f.GetCliErrorInvalidLanguage()
	case FlagPassDesc:
...
func (f FrenchBundle) GetErrThreadsMin() string { return "le nombre de threads doit être au moins 1" }
func (f FrenchBundle) GetErrThreadsMax() string { return "trop de threads: %d (maximum %d)" }
func (f FrenchBundle) GetErrThreadsExceed() string {
	return "les threads dépassent la capacité système: %d (max %d)"
}
func (f FrenchBundle) GetErrTimeMin() string     { return "le temps doit être au moins 1" }
func (f FrenchBundle) GetErrTimeMax() string     { return "temps trop élevé: %d (maximum 100)" }
func (f FrenchBundle) GetErrKeyLenShort() string { return "clé trop courte: %d bytes (minimum 16)" }
func (f FrenchBundle) GetErrKeyLenLong() string  { return "clé trop longue: %d bytes (maximum 64)" }

// CLI messages

func (f FrenchBundle) GetCliFileExists() string         { return "Le fichier '%s' existe déjà. Écraser ?" }
func (f FrenchBundle) GetCliOperationCancelled() string { return "❌ Opération annulée" }
func (f FrenchBundle) GetCliError() string              { return "❌ Erreur: %v" }
func (f FrenchBundle) GetCliErrorInvalidLanguage() string {
	return "⚠️ Langue invalide '%s', utilisation de l'anglais (en). Supportées: en, fr\n"
}
...
func (f FrenchBundle) GetFlagWorkersDesc() string { return "Nombre de workers parallèles" }
...
func (f FrenchBundle) GetFlagLangDesc() string {
	return "Langue pour l'interface (en, fr) - défaut: en"
}

// Command descriptions

func (f FrenchBundle) GetCmdEncryptShort() string { return "🔒 Chiffrer un fichier" }
...
func (f FrenchBundle) GetCmdDecryptShort() string { return "🔓 Déchiffrer un fichier" }
...
func (f FrenchBundle) GetInteractiveTitle() string       { return "Mode Interactif" }
func (f FrenchBundle) GetInteractiveEncryptFlow() string { return "Chiffrement" }
func (f FrenchBundle) GetInteractiveDecryptFlow() string { return "Déchiffrement" }
func (f FrenchBundle) GetInteractiveInputFile() string   { return "📁 Fichier à chiffrer" }
func (f FrenchBundle) GetInteractiveOutputFile() string  { return "📂 Fichier de sortie" }
func (f FrenchBundle) GetInteractivePassword() string    { return "🔑 Mot de passe" }
func (f FrenchBundle) GetInteractiveConfirm() string     { return "✅ Confirmation" }
func (f FrenchBundle) GetInteractiveWorkerCount() string { return "⚙️ Workers" }
...
func (f FrenchBundle) GetInteractiveOverwriteCancelled() string { return "❌ Opération annulée" }
func (f FrenchBundle) GetInteractiveCancel() string             { return "❌ Opération annulée" }
...
func (f FrenchBundle) GetInteractiveFileToEncrypt() string { return "📁 Fichier à chiffrer" }
func (f FrenchBundle) GetInteractiveEncryptedFile() string { return "📁 Fichier chiffré" }
...
func (f FrenchBundle) GetPasswordPrompt() string        { return "🔑 Mot de passe: " }
func (f FrenchBundle) GetPasswordConfirmPrompt() string { return "✅ Confirmation du mot de passe: " }
func (f FrenchBundle) GetPasswordEmpty() string         { return "le mot de passe ne peut pas être vide" }
func (f FrenchBundle) GetPasswordReadError() string     { return "lecture du mot de passe: %w" }
func (f FrenchBundle) GetPasswordConfirmError() string  { return "lecture de la confirmation: %w" }
func (f FrenchBundle) GetPasswordNotMatch() string      { return "les mots de passe ne correspondent pas" }
func (f FrenchBundle) GetPasswordMinLength() string     { return "8 caractères minimum requis" }
func (f FrenchBundle) GetPasswordUppercase() string     { return "au moins une lettre majuscule requise" }
func (f FrenchBundle) GetPasswordLowercase() string     { return "au moins une lettre minuscule requise" }
func (f FrenchBundle) GetPasswordDigit() string         { return "au moins un chiffre requis" }
...
func (f FrenchBundle) GetRootLongDesc() string      { return "" }
func (f FrenchBundle) GetRootUsage() string         { return "Utilisation:" }
func (f FrenchBundle) GetRootCommandsTitle() string { return "Commandes:" }
func (f FrenchBundle) GetRootHelpDesc() string {
	return "Afficher l'aide pour n'importe quelle commande"
}
func (f FrenchBundle) GetRootPasswordManagement() string { return "Gestion des mots de passe:" }
func (f FrenchBundle) GetRootPasswordManagementDesc() string {
	return `Pour les commandes encrypt et decrypt, vous pouvez soit:
  - Utiliser le flag --pass (visible dans la liste des processus)
  - Omettre le flag et entrer le mot de passe interactivement (recommandé)

Pour le chiffrement, le mode interactif inclut la confirmation du mot de passe et la validation de sa robustesse.`
}
func (f FrenchBundle) GetRootExamplesTitle() string { return "Exemples:" }
...
func (f FrenchBundle) GetRootExampleForce() string { return "# Forcer l'écrasement sans confirmation" }

// Version command messages

func (f FrenchBundle) GetVersionShortDesc() string { return "Afficher les informations de version" }
...
func (f FrenchBundle) GetVersionBuildInfo() string { return "📦 Build: %s" }
func (f FrenchBundle) GetVersionOSArch() string    { return "🖥️  OS/Arch: %s/%s" }
func (f FrenchBundle) GetVersionCPUs() string      { return "💻 CPUs: %d" }
...
func (f FrenchBundle) GetErrOpenFile() string { return "ouverture du fichier '%s': %w" }

// Service validation errors

func (f FrenchBundle) GetErrFileAlreadyExists() string { return "fichier existe déjà" }
func (f FrenchBundle) GetErrFileNotFound() string      { return "fichier '%s' inexistant" }
func (f FrenchBundle) GetWarnWorkersReduced() string   { return "⚠️ Workers réduit à %d\n" }
...
func (f FrenchBundle) GetUIEncryptHeader() string { return "🔐 CHIFFREMENT DE FICHIER" }
func (f FrenchBundle) GetUIDecryptHeader() string { return "🔓 DÉCHIFFREMENT DE FICHIER" }
...
func (f FrenchBundle) GetUIPromptOperationLabel() string    { return "Que souhaitez-vous faire" }
func (f FrenchBundle) GetUIPromptEncryptOption() string     { return "🔒  Chiffrer un fichier" }
func (f FrenchBundle) GetUIPromptDecryptOption() string     { return "🔓  Déchiffrer un fichier" }
func (f FrenchBundle) GetUIPromptExitOption() string        { return "🚪  Quitter" }
func (f FrenchBundle) GetUIPromptGoodbye() string           { return "👋 Merci d'avoir utilisé CRYPTOOL !" }
func (f FrenchBundle) GetUIPromptPathEmpty() string         { return "❌ Le chemin ne peut pas être vide" }
func (f FrenchBundle) GetUIPromptPathNotExist() string      { return "❌ Le fichier '%s' n'existe pas" }
func (f FrenchBundle) GetUIPromptPathSuccess() string       { return "   ✓ %s" }
func (f FrenchBundle) GetUIPromptPasswordMinLength() string { return "❌ 8 caractères minimum" }
func (f FrenchBundle) GetUIPromptPasswordUppercase() string { return "❌ Une majuscule requise" }
func (f FrenchBundle) GetUIPromptPasswordLowercase() string { return "❌ Une minuscule requise" }
func (f FrenchBundle) GetUIPromptPasswordDigit() string     { return "❌ Un chiffre requis" }
func (f FrenchBundle) GetUIPromptPasswordSuccess() string   { return "   ✓ %s" }
func (f FrenchBundle) GetUIPromptWorkersLabel() string {
	return "⚙️  Workers (défaut: %d, max: %d)"
}
func (f FrenchBundle) GetUIPromptWorkersSuccess() string { return "   ✓ %d workers" }
func (f FrenchBundle) GetUIPromptWorkersInvalid() string { return "❌ Nombre valide requis (>=1)" }
func (f FrenchBundle) GetUIPromptWorkersMax() string     { return "❌ Maximum %d workers" }
func (f FrenchBundle) GetUIPromptConfirmLabel() string   { return "❓ %s [%s]: " }
func (f FrenchBundle) GetUIPromptConfirmInvalid() string { return "❌ Répondez par y/n" }

// UI success messages

func (f FrenchBundle) GetUISuccessOperation() string { return "✅ Opération réussie !" }
func (f FrenchBundle) GetUISuccessOutput() string    { return "📄 Fichier: %s" }
func (f FrenchBundle) GetUISuccessSize() string      { return "📏 Taille:  %s" }

// Cryptolib decryption errors

func (f FrenchBundle) GetCryptolibErrOpenInput() string { return "ouverture du fichier d'entrée: %w" }
func (f FrenchBundle) GetCryptolibErrCreateOutput() string {
	return "création du fichier de sortie: %w"
}
func (f FrenchBundle) GetCryptolibErrCreateCipher() string   { return "création du cipher: %w" }
func (f FrenchBundle) GetCryptolibErrCreateGCM() string      { return "création du GCM: %w" }
func (f FrenchBundle) GetCryptolibErrReadHeader() string     { return "lecture de l'en-tête: %w" }
func (f FrenchBundle) GetCryptolibErrReadHeaderHMAC() string { return "lecture du HMAC d'en-tête: %w" }
func (f FrenchBundle) GetCryptolibErrReadNonce() string      { return "lecture du nonce: %w" }
...
func (f FrenchBundle) GetCryptolibErrGenerateSalt() string { return "génération du sel: %w" }
func (f FrenchBundle) GetCryptolibErrWriteHeader() string  { return "écriture de l'en-tête: %w" }
func (f FrenchBundle) GetCryptolibErrWriteHeaderHMAC() string {
	return "écriture du HMAC d'en-tête: %w"
}
func (f FrenchBundle) GetCryptolibErrCreateCipherEnc() string { return "création du cipher: %w" }
func (f FrenchBundle) GetCryptolibErrCreateGCMEnc() string    { return "création du GCM: %w" }
func (f FrenchBundle) GetCryptolibErrGenerateNonce() string   { return "génération du nonce: %w" }
func (f FrenchBundle) GetCryptolibErrWriteNonce() string      { return "écriture du nonce: %w" }
func (f FrenchBundle) GetCryptolibErrReadChunk() string       { return "lecture du chunk: %w" }
...
func (f FrenchBundle) GetCryptolibErrCloseInput() string  { return "fermeture de l'entrée: %w" }
func (f FrenchBundle) GetCryptolibErrCloseOutput() string { return "fermeture de la sortie: %w" }
...
func (f FrenchBundle) GetCryptolibErrReadHeaderStream() string { return "lecture de l'en-tête: %w" }
func (f FrenchBundle) GetCryptolibErrReadHeaderHMACStream() string {
	return "lecture du HMAC d'en-tête: %w"
}
func (f FrenchBundle) GetCryptolibErrReadNonceStream() string { return "lecture du nonce: %w" }
...
func (f FrenchBundle) GetCryptolibErrCreateCipherStream() string { return "création du cipher: %w" }
func (f FrenchBundle) GetCryptolibErrCreateGCMStream() string    { return "création du GCM: %w" }
